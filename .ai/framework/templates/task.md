...
## Acceptance criteria
TODO — criterion IDs and observable outcomes; no undefined material behavior.

## Required verification
TODO — checks/commands where known, environment needs and expected evidence.

## Worker preflight
Worker records understanding, intended changes/checks and any mismatch in its attempt report before editing. Continue immediately if aligned; return material contract discrepancies to the manager.

## Integration and closure boundary
